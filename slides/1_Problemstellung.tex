...
\end{itemize}
\vspace{5mm}
\hspace{5mm}\rightarrow\hspace{5mm} Reduktion der Entwicklungsgeschwindigkeit
\end{frame}
...
\begin{alertblock}{Problem}
    QEMU enthält keine Integration für den STM32F429 Mikrocontroller, aber
    Integrationen für verwandete Mikrocontroller der STM32F2 und F4 Familien
    und kompatibler Peripherie.
\end{alertblock}
